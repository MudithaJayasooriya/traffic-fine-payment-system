function StatCard({ title, value, icon: Icon, color = "text-[#4aa3ff]" }) {
  return (
    <div className="bg-[#07223a] border border-[#1f4f78] rounded-xl p-4 shadow-lg flex items-center justify-between transition-all duration-200 hover:border-[#4aa3ff]/50">
      <div>
